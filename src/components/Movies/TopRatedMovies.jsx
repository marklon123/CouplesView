...
function TopRatedMovies() {
                        ...
                        <div className="flex flex-col items-center justify-center my-1 sm:my-2">
                            ...
                            <div className="mt-1">
                                <span className="flex items-center">
                                    <p className="cardTime text-tertiary text-[13px] md:text-sm">{`${currentMedia?.runtime} min`}</p>
    ...
    return (
        <section className="flex justify-center">
            <div className="container relative p-2 pb-4">
                ...
                <div className="heading relative">
                    <div className="flex justify-between items-center pt-2 sm:pt-3">
                        <h1 className="trendingHeading text-tertiary text-lg md:text-2xl 2xl:3xl font-medium">Top Rated Movies</h1>
                        <a className="cursor-pointer flex items-center nowrap text-sm sm:text-md bg-secondary bg-opacity-80 rounded-full p-[2px] px-2 sm:px-3 md:px-4">
                            <p className="text-cta text-sm mb-[2px] sm:text-base sm:font-medium sm:mb-1">more</p>
